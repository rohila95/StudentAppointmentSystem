<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
       ...
       $recPosID = @trim(stripslashes($_POST['recPosID']));
	    ...
	    $QueryUpdateRecPos = "UPDATE RecruitPositions SET currentpost='$currentpost', salarypaid=$salarypaid,hours=$hoursip,project_id=$projid,fundingtype=$fundingip WHERE id=".$recPosID;
