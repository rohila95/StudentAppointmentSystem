...
<meta name="keywords"
	content="Appointment System,CS,ODU,Norfolk,Students,Tracking,Appointment,Maheedhar,Handson">
...
<div class="form-group"><label for="projNoCNP"">Project No:</label> <input
	type="text" class="form-control" name="name" id="projNoCNP"
	placeholder="Enter Project Code"></div>
<div class="form-group"><label for="projTypeCNP"">Project Type:</label>
...
<div class="form-group"><label for="projAgencyCNP"">Agency:</label> <input
	type="text" class="form-control" name="agency" id="projAgencyCNP"
	placeholder="Enter Agency"></div>
<div class="form-group"><label for="projDescCNP"">Description:</label> <textarea
	class="form-control" id="projDescCNP" name="projectdescription"> </textarea>
</div>
<div class="form-group"><label for="projSDateCNP"">Start Date:</label> <input
	type="date" class="form-control" id="projSDateCNP"
	name="projectstartdate" /></div>
<div class="form-group"><label for="projEDateCNP"">End Date:</label> <input
	type="date" class="form-control" id="projEDateCNP"
	name="projectenddate" /></div>
<div class="form-group"><label for="faculty_name"">Faculty Name:</label>
...
<div class="modal-footer">
<button type="button" class="btn btn-warning notConfirmed"
	data-dismiss="modal">No</button>
<button type="button" class="btn btn-success confirmed"
...
<div class="form-group"><label for="usr">UIN:</label> <input name="uin"
	type="number" name="uin" class="form-control" id="uin"
	placeholder="01041411" maxlength="8"></div>
<div class="form-group"><label>firstname:</label> <input
	name="first_name" type="text" class="form-control"
	id="addstudent_firstname" required></div>
<div class="form-group"><label>lasttname:</label> <input
	name="last_name" type="text" class="form-control"
	id="addstudent_lastname" required></div>
<div class="form-group"><label>email</label> <input name="email"
	type="email" class="form-control" id="addstudent_email"
	placeholder="ex-example@odu.edu"
	data-error="Bruh, that email address is invalid" required></div>
<div class="form-group"><label>gradlevel</label> <input name="gradlevel"
	type="text" class="form-control" id="addstudent_gradlevel"
	placeholder="ex-grad/php" required></div>
<div class="form-group"><label>i9expiry</label> <input name="i9expiry"
	type="text" class="form-control" id="addstudent_i9expiry"></div>
</form>

</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" onclick="AddStudenttoDB()">Add
Student</button>
</div>
</div>
...
<div class="well well-sm hidden"><b style="margin-left: 40%;">Appointed
Students List</b></div>
<div class="row studentTableTop"><?php	            
if($isAdmin){
				...
				if($adminType == 1){
					switch ($row['currentpost']) {
						...
						case "GTA":
							...
							break;
						case "PHD_GRA":
							echo "<td class='stuPost'><select class='form-control adminUpdatedStuPost'><option value='PHD_SGRA'>PHD_SGRA</option><option value='PHD_Grader'>PHD_Grader</option><option value='PHD_GTA'>PHD_GTA</option><option value='PHD_GRA' selected>PHD_GRA</option></select></td>";
							break;
						case "PHD_SGRA":
							echo "<td class='stuPost'><select class='form-control adminUpdatedStuPost'><option value='PHD_SGRA' selected>PHD_SGRA</option><option value='PHD_Grader'>PHD_Grader</option><option value='PHD_GTA'>PHD_GTA</option><option value='PHD_GRA'>PHD_GRA</option></select></td>";
							break;
						case "PHD_Grader":
							echo "<td class='stuPost'><select class='form-control adminUpdatedStuPost'><option value='PHD_SGRA'>PHD_SGRA</option><option value='PHD_Grader' selected>PHD_Grader</option><option value='PHD_GTA'>PHD_GTA</option><option value='PHD_GRA' selected>PHD_GRA</option></select></td>";
							break;
						case "PHD_GTA":
							echo "<td class='stuPost'><select class='form-control adminUpdatedStuPost'><option value='PHD_SGRA'>PHD_SGRA</option><option value='PHD_Grader'>PHD_Grader</option><option value='PHD_GTA' selected>PHD_GTA</option><option value='PHD_GRA' selected>PHD_GRA</option></select></td>";
							break;			
					}
					if($row['fundingtype'] == "1"){
...
<div class="row">
<div class="col-lg-12">
<h5>Please validate the following Check List of the Student - <label
	class="studentDetADM"> </label> before Preparing Offer Letter.</h5>
</div>
</div>
...
<form class="form-inline formLPA formFinancialAdmin" action="#"
	Method="POST" name="offerUploadForm_LPA">
<div class="CheckBox" style="margin-top: -5px;"><label><input
	type="checkbox" purp="Funds Availability" value=""
	class="fundsValidateCB"><b style="margin-left: 4px;">Funds Availability</b></label>
</div>

<div class="form-group" style="margin-left: 20%;">- Tution Cost: $ <input
	class="form-control tutionCost" type="number" disabled
	style="width: 20%;" /> Student Stipend: $ <input
	class="form-control studentsCost" type="number" disabled
	style="width: 20%;" /></div>
<div class="form-group fundsValidateButtFG">
<div class="col-sm-8">
<button type="button" class="btn btn-default btn-success"
	id="fundsvalidateButt_LPFA"
	title="Click to update the funds Availablity" the
	style="display: none;">Validate</button>
</div>
</div>
</form>

<form class="form-inline formLPA formGradAdmin" action="#" Method="POST"
	name="offerUploadForm_LPA">

<div class="CheckBox" style="margin-top: -5px;"><label><input
	type="checkbox" purp="I9" value=""><b style="margin-left: 4px;">Validate
I9</b> </label></div>

<div class="form-group">- Expiry Date: <input
	class="form-control studentsI9Expiry" type="date" /> &nbsp; <input
	type="button" class="btn btn-default i9ExpiryUpdateButt" value="Update"
...
<div class="CheckBox" style="margin-top: -5px;"><label><input
	type="checkbox" purp="Academic Status" value=""><b
	style="margin-left: 4px;">Student's Academic Status</b> </label></div>
</form>

<form class="form-inline formLPA formGradAdmin" action="#" Method="POST"
	name="offerUploadForm_LPA">
<div class="CheckBox" style="margin-top: -5px;"><label><input
	type="checkbox" purp="No Of Credits Registered" value=""><b
	style="margin-left: 4px;">Credits Registered Check</b> </label></div>
</form>

<form class="form-horizontal formGradAdmin">
<div class="form-group">
<div class="col-sm-5"><input type="file" class="btn btn-primary"
	style="width: 107%;"
	accept="application/msword,application/vnd.ms-powerpoint,application/pdf"
	id="uploadOfferFile_LPA" name="filetoUpload"></div>
<div class="col-sm-5"><a href="#" class="sendEmailToStudent"
	data-toggle="collapse" data-target="#emailNotifDiv"
	title="Send an email remainder to student">Send an Email </a><br />
<div id="emailNotifDiv" class="collapse well">

<div class="form-group"><label for="emailNotifSub">Email Subject:</label>
<input type="text" id="emailNotifSub" class="form-control "
	placeholder="Enter email Subject"></div>
<div class="form-group"><label for="emailNotifBody">Body:</label> <textarea
	class="form-control" id="emailNotifBody" placeholder="Enter Email Body"></textarea>
</div>
<input type="button" class="btn btn-default emailNotifStudentSend"
	value="Send"></input></div>
<a href="#" class="generateATag" target="_blank">Generate Appointment
Letter!</a></div>
</div>
...
<div class="col-sm-8">
<button type="button" class="btn btn-default btn-success"
	id="offerUpload_Email_LPA">Upload & Email</button>
</div>
</div>
</form>
...
<div class="modal-footer">
<button type="button" class="btn btn-default adminValidationCloseButt"
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal">&times;</button>
<h4 class="modal-title exitFileAttachModalHeader">Attach the Existing
Offer Letter</h4>
</div>
